...
public class HealthPickupEntity extends BasicEntity {

	public HealthPickupEntity(Decal decal, LightHolder lightHolder, Body body, final String amount) {
		...
		this.addListener(new Listener() {
			...
			public void handleEvent(Event event) {
				if (event.getType() == EventType.COLLISION) {
					...
					if (entity != null) {
						entity.getHurt(-Integer.valueOf(amount));
						getHurt(1);
					}
				}
			}
